...
class Comm_Node:
    def __init__(self):
        ...
        try:
            ...
            self.speed_pub = rospy.Subscriber(
                "/mavros/time_reference", TimeReference, self.speed_callback
            )
        ...
        self.telemetry_thread.daemon = True  # Ensure the thread will exit when the main program ends
