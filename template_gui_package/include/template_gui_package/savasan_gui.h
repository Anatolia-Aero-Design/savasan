...
private slots:
  ...
  void on_hss_request_clicked();

  void on_hss_push_clicked();

  void on_set_param_for_diveClicked();

  void on_set_param_for_safe_flyClicked();

  void on_getparamsClicked();

  void on_abort_kamikazeClicked();

  void on_send_lock_dataClicked();
