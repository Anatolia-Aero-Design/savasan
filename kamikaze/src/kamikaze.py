...
class UAVWaypointManager:
    def __init__(self):
        ...
        # Target coordinates
        self.target_latitude = 36.93928229
        self.target_longitude =35.5619807
        self.target_altitude = 20
        
        self.competition_center_lat = 36.939918
        self.competition_center_lon = 35.558085
        self.competition_center_alt = 100
    ...
    def calculate_waypoint_coordinates(self, radii, azimuth_angle, altitude):
        ...
        enu_coords.append(
            (exit_x+target_x, exit_y+target_y, self.target_altitude))
        ...
        geodetic_coords.append((self.competition_center_lat, self.competition_center_lon, self.competition_center_alt))
    ...
    def handle_start_mission(self, req):
        ...
        qr_text = ""
        while 1:
            if self.last_rec_wp == 1 and not self.kamikaze_started and not self.dive_param_set:
                utils.set_params_for_dive()
                self.dive_param_set = 1
