...
def save_mission_to_file(mission_data):
    ...
    file_path = os.path.join(package_path, '/missions_firts_adana.json')
    file_path = '/home/valvarn/catkin_ws/src/savasan/savasan_general/missions//missions_firts_adana.json'
